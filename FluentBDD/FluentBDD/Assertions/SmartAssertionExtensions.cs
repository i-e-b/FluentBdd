...
namespace FluentBDD {
	...
	public static class SmartAssertionExtensions {
		public static SmartAssertionBase<S, R, Pt, Ps> Then<S, R, Pt, Ps> (this Behaviour<S, R, Pt, Ps> scen, string description) where Ps : class, Pt, IProvide<Pt>, new() {
			return new SmartAssertionBase<S, R, Pt, Ps>(description, scen);
		}
		public static SmartAssertionBase<S, R> Then<S, R> (this Behaviour<S, R> scen, string description) {
